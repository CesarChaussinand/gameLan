...
(async () => {
    ...
    //const { faustNode, dspMeta: { name } } = await createFaustNode(audioContext, "untitled", 0, true);
    const { faustNode, dspMeta: { name } } = await createFaustNode(audioContext, "untitled");
